...
class MyDatabaseHelper extends SQLiteOpenHelper {
    ...
    void addBook(String title, String author, int pages){
        ...
        if(result == -1){
            ...
            Toast.makeText(context, "¡Agregado Satisfactoriamente!", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    void deleteOneRow(String row_id){
        ...
        if(result == -1){
            ...
            Toast.makeText(context, "¡Eliminación satisfactoria.", Toast.LENGTH_SHORT).show();
        }
    }
